...
var answers_file = 'https://preetiramaraj.github.io/VizStudy1/text/answers.json';
var viz_file = 'https://preetiramaraj.github.io/VizStudy1/text/viz.json';
   ...
   // document.getElementById('answerBtn').setAttribute("disabled", true);
    ...
    if (curr_exp === 16) {
        ...
        if (arr_qa.indexOf(curr_id) != -1) {
            ...
            file2 = 'https://preetiramaraj.github.io/VizStudy1/text/' + curr_id.toString() + '.json';
...
function change_image(curr_id, textContent) {
    var src = "";
    switch (textContent) {
        case "Show annotations": src = "https://preetiramaraj.github.io/VizStudy1/images/img_" + curr_id + "_annotations.png";
            break;
        case "Show original": src = "https://preetiramaraj.github.io/VizStudy1/images/img_" + curr_id + ".png";
            break;
        case "Show clear": src = "https://preetiramaraj.github.io/VizStudy1/images/img_" + curr_id + "_clear.png";
            break;
        case "Show free": src = "https://preetiramaraj.github.io/VizStudy1/images/img_" + curr_id + "_free.png";
            break;
        case "Show matched": src = "https://preetiramaraj.github.io/VizStudy1/images/img_" + curr_id + "_matched.png";
            break;
        case "Show occupied": src = "https://preetiramaraj.github.io/VizStudy1/images/img_" + curr_id + "_occupied.png";
            break;
...
function readyToAnswer() {
    ...
    //     });
        ...
        // });
    $.post('https://preetiramaraj.github.io/VizStudy1/save_data.php',{imgname: 'preeti', imghell: "god i hate this"},
...
function exit_to_survey() {
    window.location.href = "https://preetiramaraj.github.io/VizStudy1/exitsurvey.html";
}
