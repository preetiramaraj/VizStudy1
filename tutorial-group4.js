...
function submitAnswer()
{
	...
	var ytime = setTimeout(function() {
		// Send to main task.
	        window.location = "https://hawk.eecs.umich.edu/VizStudy/index-group4.html" + "?workerId=" + gup("workerId") + "&assignmentId=" + gup("assignmentId") +"&turkSubmitTo="+gup("turkSubmitTo")+"&hitId="+gup("hitId");
	}, 3000);
    }
    else if(j === 0)
    {
