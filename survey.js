...
function submitAnswer()
{
		...
		data_val["gender"] = $("input[name='gender']").val();
		data_val["age"] =  $("input[name='age']").val();
		data_val["FreeTextQNA"] =  $("input[name='FreeTextQNA']").val();
		data_val["FreeTextViz"] =   $("input[name='FreeTextViz']").val();
		data_val["pref"] =                  $("input[name='pref']").val();
		...
		data_val["qna_quickly"] =  $("input[name='qna_quickly']").val();
		data_val["qna_easy"] =  $("input[name='qna_easy']").val();
		data_val["qna_useful"] =  $("input[name='qna_useful']").val();
		data_val["qna_easier"] =  $("input[name='qna_easier']").val();
		data_val["qna_future"] =    $("input[name='qna_future']").val();
		data_val["viz_quickly"] =  $("input[name='viz_quickly']").val();
		data_val["viz_easy"] =  $("input[name='viz_easy']").val();
		data_val["viz_useful"] =  $("input[name='viz_useful']").val();
		data_val["viz_easier"] =  $("input[name='viz_easier']").val();
		data_val["viz_future"] =  $("input[name='viz_future']").val();
		 var val = [];
